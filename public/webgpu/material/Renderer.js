...
export class Renderer extends WebGPURenderer {
	...
	async #loadShaderModules() {
		...
		const visibilityVertexShaderSource = await shaderLoader.load("public/webgpu/material/shaders/visibility.vert.wgsl");
		const visibilityFragmentShaderSource = await shaderLoader.load("public/webgpu/material/shaders/visibility.frag.wgsl");
