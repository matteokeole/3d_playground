...
export class FreecamDevInstance extends Instance {
	...
	#onMouseMove(event) {
		...
		const pitch = this.getMouseYAxis(event) * FreecamDevInstance.#SENSITIVITY;
		const yaw = this.getMouseXAxis(event) * FreecamDevInstance.#SENSITIVITY;
