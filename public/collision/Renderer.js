...
export class Renderer extends WebGLRenderer {
	...
	async #loadPrograms() {
		...
		const mainVertexShaderSource = await shaderLoader.load("public/collision/shaders/main.vert");
		// const depthVertexShaderSource = await shaderLoader.load("public/collision/shaders/depth.vert");
		const crosshairVertexShaderSource = await shaderLoader.load("public/collision/shaders/crosshair.vert");
		...
		const mainFragmentShaderSource = await shaderLoader.load("public/collision/shaders/main.frag");
		const crosshairFragmentShaderSource = await shaderLoader.load("public/collision/shaders/crosshair.frag");
